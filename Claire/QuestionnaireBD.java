		...
		try{
			...
			while(rs.next()){
				...
				// sinon c'est un nouveau questionnaire
					...
					Questionnaire q = new Questionnaire(rs.getString("Titre"),rs.getInt("idq"), rs.getInt("numC"), rs.getInt("idU"), rs.getInt("idPan"), rs.getString("etat").charAt(0));
			...
			while(rs2.next()){
				Questionnaire q = new Questionnaire(rs2.getString("Titre"),rs.getInt("idq"), rs2.getInt("numC"),  rs2.getInt("idU"),  rs2.getInt("idPan"),  rs2.getString("etat").charAt(0));
	...
	public Questionnaire creerQuestionnaire(int idQ){
		...
		try{
			...
			while(rs.next()){
				...
				res=new Questionnaire(titreQuestionnaire,rs.getInt("idq"), rs.getInt("numC"),  rs.getInt("idU"),  rs.getInt("idPan"), rs.getString("etat").charAt(0));
			}
