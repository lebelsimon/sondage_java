	...
	public static void main(String[] args) {
		...
		while (!fini) {
			...
			case 14:
				...
				break;
			case 15:
				tjdbc.questionnaire.ajouterQuestionnaire(new Questionnaire("ajout questionnaire test",0, 15688, 7, 2, 'S'));
				break;
			case 16:
				Questionnaire qu = new Questionnaire("Questionnaire test modifié",1, 15688, 4, 1, 'S');
				qu.setIdQ(9);
